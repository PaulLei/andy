...
const publications = [
  {
    year: 2025,
    title: 'Automated Detection of Seizure Onset Zone Using Machine Learning',
    authors: 'Sarma, S.V., et al.',
  ...
  {
    year: 2024,
    title: 'EpiScalp: Clinical Validation of EEG-Based Epilepsy Diagnosis',
    authors: 'Martinez, J.G., Sarma, S.V., et al.',
  ...
  {
    year: 2024,
    title: 'Deep Learning Methods for Seizure Detection in Scalp EEG',
    authors: 'Sharifian, G., Sarma, S.V.',
  ...
  {
    year: 2023,
    title: 'Clinical Implementation of AI-Assisted EEG Analysis',
    authors: 'Hays, M., Martinez, J.G., et al.',
    journal: 'Epilepsia',
  ...
  {
    year: 2023,
    title: 'EZTrack: Surgical Planning Tool for Epilepsy Management',
    authors: 'Martinez, J.G., et al.',
  ...
  {
    year: 2022,
    title: 'Signal Processing Advances in Epilepsy Diagnosis',
    authors: 'Sarma, S.V., Sharifian, G.',
